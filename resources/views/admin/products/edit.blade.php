...
// for productSubCategoryController
$("#category").change(function(){  // calling this function on category of changing event
...
$.ajax({
    ...
    // calling slug field after i fill out name field
$("#title").change(function(){
 var element = $(this); // target the name field
   $("button[type=submit]").prop('disabled',true);
    $.ajax({
url: '{{ route("getSlug") }}',
type: 'post',
...
Dropzone.autoDiscover = false; // rendering the file
const dropzone = $("#image").dropzone({
 
  url: "{{ route('product-images.update')}}",
  maxFiles: 10,
  paramName: 'image', //by default to be file
...
function deleteImage(id){
    $("#image-row-"+id).remove();  // delete the element on browser
    
    if(confirm("Ary you sure you want to delete the picture")){
        $.ajax({
