            ...
            <div class="col-md-5">
                <div id="product-carousel" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner bg-light">
                        ...
                        <div class="carousel-item {{ ( $key == 0 )? 'activate' : '' }} ">
                            @if (!empty($productImage->image))
                            
                            <img class="w-100 h-100" src="{{ asset('uploads/product/large/'.$productImage->image)}}" alt="Image">
                            
                            @else
                            <img class="w-100 h-100" src="{{ asset('admin-assets/img/product-1.jpg')}}" alt="Image">
    ...
    <div class="container">
        ...
        <div class="col-md-12">
            <div id="related-products" class="carousel">
               ...
               @php
            $productImage = $relProduct->product_images->first();   // with the help of relation, this is in productController 
            @endphp
...
{{--addToCart function is added in front.layouts.app.blade because this is used in everywhere--}}
